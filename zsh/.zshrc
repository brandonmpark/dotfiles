...
alias pn=pnpm
# pnpm end
export PATH=$PATH:/Users/brandonmpark/.spicetify

export PATH="/Users/brandonmpark/anaconda3/bin:$PATH"
# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/Users/brandonmpark/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/brandonmpark/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/brandonmpark/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/brandonmpark/anaconda3/bin:$PATH"
    fi
fi
